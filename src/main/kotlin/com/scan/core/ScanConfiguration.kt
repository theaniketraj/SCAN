...
data class ScanConfiguration(
    ...
    fun mergeWith(other: ScanConfiguration): ScanConfiguration {
        return copy(
            ...
            includePatterns =
            if (other.includePatterns != DEFAULT_INCLUDE_PATTERNS) {
                other.includePatterns
            } else {
            ...
            maxFileSize =
            if (other.maxFileSize != DEFAULT_MAX_FILE_SIZE) {
                other.maxFileSize
            } else {
                this.maxFileSize
            },
...
data class EntropyConfiguration(
    ...
    fun mergeWith(other: EntropyConfiguration): EntropyConfiguration {
        return copy(
            enabled = other.enabled,
            threshold =
            if (other.threshold != ScanConfiguration.DEFAULT_ENTROPY_THRESHOLD) {
                other.threshold
            } else {
                this.threshold
            },
            minLength =
            if (other.minLength != ScanConfiguration.DEFAULT_MIN_SECRET_LENGTH) {
                other.minLength
            } else {
                this.minLength
            },
            maxLength =
            if (other.maxLength != ScanConfiguration.DEFAULT_MAX_SECRET_LENGTH) {
                other.maxLength
            } else {
                this.maxLength
            },
...
data class ContextConfiguration(
    ...
    fun mergeWith(other: ContextConfiguration): ContextConfiguration {
        return copy(
            ...
            contextLines =
            if (other.contextLines != ScanConfiguration.DEFAULT_CONTEXT_LINES) {
                other.contextLines
            } else {
                this.contextLines
            },
...
data class FilterConfiguration(
    ...
    fun mergeWith(other: FilterConfiguration): FilterConfiguration {
        return copy(
            ...
            maxLineLength =
            if (other.maxLineLength != ScanConfiguration.DEFAULT_MAX_LINE_LENGTH) {
                other.maxLineLength
            } else {
                this.maxLineLength
            },
...
data class ReportingConfiguration(
    ...
    fun mergeWith(other: ReportingConfiguration): ReportingConfiguration {
        return copy(
            enabled = other.enabled,
            formats =
            if (other.formats != setOf(ReportFormat.CONSOLE)) {
                other.formats
            } else {
                this.formats
            },
            outputPath =
            if (other.outputPath != "scan-results") {
                other.outputPath
            } else {
                this.outputPath
            },
...
data class PerformanceConfiguration(
    ...
    fun mergeWith(other: PerformanceConfiguration): PerformanceConfiguration {
        return copy(
            ...
            timeoutSeconds =
            if (other.timeoutSeconds != 300) {
                other.timeoutSeconds
            } else {
                this.timeoutSeconds
            },
            memoryLimitMB =
            if (other.memoryLimitMB != 1024) {
                other.memoryLimitMB
            } else {
                this.memoryLimitMB
            },
            ...
            cacheDirectory =
            if (other.cacheDirectory != ".scan-cache") {
                other.cacheDirectory
            } else {
                this.cacheDirectory
            }
        )
...
data class ValidationConfiguration(
    ...
    fun mergeWith(other: ValidationConfiguration): ValidationConfiguration {
        return copy(
            ...
            timeoutSeconds =
            if (other.timeoutSeconds != 10) {
                other.timeoutSeconds
            } else {
                this.timeoutSeconds
            },
            maxConcurrentValidations =
            if (other.maxConcurrentValidations != 5) {
                other.maxConcurrentValidations
            } else {
