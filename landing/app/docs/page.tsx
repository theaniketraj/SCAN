        ...
        <div className="container mx-auto px-4 sm:px-6 py-8 sm:py-12 max-w-4xl">
            <div className="prose prose-lg dark:prose-invert max-w-none">
                ...
                <p className="text-xl text-gray-600 dark:text-gray-300">
                    Find quickstart, configuration reference and CI examples for
                    the SCAN Gradle Plugin.
                </p>
                ...
                <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3 mt-8 not-prose">
                    ...
                    <div className="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg p-6 hover:border-primary-300 dark:hover:border-primary-600 transition-colors">
                        ...
                        <p className="text-gray-600 dark:text-gray-300 mb-4">
                            Quick setup and installation guide to get SCAN
                    ...
                    <div className="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg p-6 hover:border-primary-300 dark:hover:border-primary-600 transition-colors">
                        ...
                        <p className="text-gray-600 dark:text-gray-300 mb-4">
                            Complete reference for all configuration options and
                            settings.
                        </p>
                        <Link
                    ...
                    <div className="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg p-6 hover:border-primary-300 dark:hover:border-primary-600 transition-colors">
                        ...
                        <p className="text-gray-600 dark:text-gray-300 mb-4">
                            Built-in patterns and guide for creating custom
                            detection patterns.
                        </p>
                        <Link
                            href="/docs/patterns"
                    ...
                    <div className="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg p-6 hover:border-primary-300 dark:hover:border-primary-600 transition-colors">
                        ...
                        <p className="text-gray-600 dark:text-gray-300 mb-4">
                            Simple examples and common patterns to get you
                            started quickly.
                        </p>
                        <Link
                    ...
                    <div className="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg p-6 hover:border-primary-300 dark:hover:border-primary-600 transition-colors">
                        ...
                        <p className="text-gray-600 dark:text-gray-300 mb-4">
                            Integration examples for GitHub Actions, Jenkins,
                            GitLab CI and more.
                        </p>
                        <Link
                            href="/docs/ci"
