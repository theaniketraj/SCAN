...
export default function ConfigurationPage() {
        ...
        <DocsLayout sections={sections} title="Configuration Reference">
            <div className="prose prose-lg dark:prose-invert max-w-none">
                ...
                <p className="text-xl text-gray-600 dark:text-gray-300">
                    ...
                    configuration options available in the SCAN Gradle Plugin.
                </p>

                <h2 id="overview">Configuration Overview</h2>

                <p>
                    All SCAN configuration is done through the <code>scan</code>{" "}
                    extension block in your <code>build.gradle.kts</code>:
                </p>
                ...
                <div className="space-y-6">
                    <div className="bg-gray-50 dark:bg-gray-800 rounded-lg p-6">
                        ...
                        <ul className="space-y-1">
                            ...
                            <li>
                                <strong>Description:</strong> Fail the build
    ...
    failOnSecrets = false  // Only warn, don't fail build
                    ...
                    <div className="bg-gray-50 dark:bg-gray-800 rounded-lg p-6">
                        ...
                        <ul className="space-y-1">
                            ...
                            <li>
                                <strong>Description:</strong> Enable detailed
                                console output
                            </li>
                        </ul>
                        <pre className="bg-gray-900 text-white p-3 rounded mt-3 text-sm">
    ...
    verbose = true  // Show detailed scanning progress
                    ...
                    <div className="bg-gray-50 dark:bg-gray-800 rounded-lg p-6">
                        ...
                        <ul className="space-y-1">
                            ...
                            <li>
                                <strong>Description:</strong> Show warnings even
                                when not failing the build
                            </li>
                        </ul>
                        <pre className="bg-gray-900 text-white p-3 rounded mt-3 text-sm">
                            <code>{`scan {
                ...
                <div className="space-y-6">
                    <div className="bg-gray-50 dark:bg-gray-800 rounded-lg p-6">
                        ...
                        <ul className="space-y-1">
                            ...
                            <li>
                                <strong>Default:</strong> Common source file
                                patterns
                            </li>
                            <li>
                                <strong>Description:</strong> Ant-style patterns
                                for files to include in scanning
                            </li>
                        </ul>
                        <pre className="bg-gray-900 text-white p-3 rounded mt-3 text-sm">
                            <code>{`scan {
        ...
        "*.properties"
                    ...
                    <div className="bg-gray-50 dark:bg-gray-800 rounded-lg p-6">
                        ...
                        <ul className="space-y-1">
                            ...
                            <li>
                                <strong>Default:</strong> Build directories and
                                generated files
                            </li>
                            <li>
                                <strong>Description:</strong> Ant-style patterns
                                for files to exclude from scanning
                            </li>
                        </ul>
                        <pre className="bg-gray-900 text-white p-3 rounded mt-3 text-sm">
                            <code>{`scan {
        ...
        "**/*.generated.*"
                    ...
                    <div className="bg-gray-50 dark:bg-gray-800 rounded-lg p-6">
                        ...
                        <ul className="space-y-1">
                            ...
                            <li>
                                <strong>Description:</strong> Whether to scan
                                test directories
                            </li>
                        </ul>
                        <pre className="bg-gray-900 text-white p-3 rounded mt-3 text-sm">
                ...
                <div className="space-y-6">
                    <div className="bg-gray-50 dark:bg-gray-800 rounded-lg p-6">
                        ...
                        <ul className="space-y-1">
                            ...
                            <li>
                                <strong>Description:</strong> Enable all
                                detectors with maximum sensitivity
                            </li>
                        </ul>
                        <pre className="bg-gray-900 text-white p-3 rounded mt-3 text-sm">
                            <code>{`scan {
    strictMode = true  // Maximum security, may increase false positives
                    ...
                    <div className="bg-gray-50 dark:bg-gray-800 rounded-lg p-6">
                        ...
                        <ul className="space-y-1">
                            ...
                            <li>
                                <strong>Default:</strong> <code>4.5</code>
                            </li>
                            <li>
                                <strong>Description:</strong> Minimum entropy
                                threshold for random string detection (0.0-8.0)
                            </li>
                        </ul>
                        <pre className="bg-gray-900 text-white p-3 rounded mt-3 text-sm">
                            <code>{`scan {
    entropyThreshold = 5.0  // Higher = fewer false positives
                    ...
                    <div className="bg-gray-50 dark:bg-gray-800 rounded-lg p-6">
                        ...
                        <ul className="space-y-1">
                            ...
                            <li>
                                <strong>Description:</strong> Custom regex
                                patterns for organization-specific secrets
                            </li>
                        </ul>
                        <pre className="bg-gray-900 text-white p-3 rounded mt-3 text-sm">
                            <code>{`scan {
                ...
                <div className="space-y-6">
                    <div className="bg-gray-50 dark:bg-gray-800 rounded-lg p-6">
                        ...
                        <ul className="space-y-1">
                            ...
                            <li>
                                <strong>Description:</strong> Generate an HTML
    ...
    generateHtmlReport = true
                    ...
                    <div className="bg-gray-50 dark:bg-gray-800 rounded-lg p-6">
                        ...
                        <ul className="space-y-1">
                            ...
                            <li>
                                <strong>Description:</strong> Generate a JSON
                ...
                <div className="space-y-6">
                    <div className="bg-gray-50 dark:bg-gray-800 rounded-lg p-6">
                        ...
                        <ul className="space-y-1">
                            ...
                            <li>
                                <strong>Description:</strong> Maximum number of
                ...
                <div className="space-y-6">
                    <div className="bg-gray-50 dark:bg-gray-800 rounded-lg p-6">
                        ...
                        <ul className="space-y-1">
                            ...
                            <li>
                                <strong>Description:</strong> Skip scanning test
    ...
    ignoreTestFiles = false  // Include test files in scanning
                ...
                <div className="space-y-6">
                    <div className="bg-gray-50 dark:bg-gray-800 rounded-lg p-6">
                        <p>
                            SCAN supports various environment variables for
                            configuration:
                        </p>
                        <ul className="space-y-2">
                            <li>
                                <code>SCAN_FAIL_ON_SECRETS</code> - Override
                                failOnSecrets setting
                            </li>
                            <li>
                                <code>SCAN_VERBOSE</code> - Enable verbose
                                output
                            </li>
                            <li>
                                <code>SCAN_OUTPUT_DIR</code> - Set custom output
                                directory
                            </li>
                        </ul>
                    </div>
                ...
                <div className="bg-green-50 dark:bg-green-900/20 border border-green-200 dark:border-green-800 rounded-lg p-6 my-8">
                    ...
                    <ul className="text-green-700 dark:text-green-300 space-y-2">
                        ...
                        <li>
                            ...
                            : Built-in patterns and custom pattern creation
                        </li>
                        <li>
                            <Link
                                href="/docs/ci"
