        ...
        <>
            ...
            <DocsLayout sections={sections} title="Getting Started">
                ...
                <p className="text-xl text-gray-600 dark:text-gray-300">
                    ...
                    help you install, configure, and run your first security
                    scan.
                </p>
                ...
                <section id="introduction">
                    <h2>Introduction</h2>
                    <p>
                        SCAN (Sensitive Code Analyzer for Nerds) is a powerful
                        Gradle plugin designed to automatically detect secrets,
                        API keys, and other sensitive information in your
                        codebase. It integrates seamlessly into your build
                        process and helps prevent accidental exposure of
                        sensitive data.
                    </p>

                    <div className="bg-green-50 dark:bg-green-900/30 border border-green-200 dark:border-green-700 rounded-lg p-4 my-6">
                        <h3 className="text-green-800 dark:text-green-200 text-lg font-semibold mb-2">
                            Key Features
                        </h3>
                        <ul className="text-green-700 dark:text-green-300 mb-0">
                            <li>
                                🔍 Comprehensive pattern detection for various
                                secret types
                            </li>
                            <li>
                ...
                <section id="requirements">
                    <h2>Requirements</h2>
                    <p>
                        Before installing SCAN, ensure your environment meets
                        these requirements:
                    </p>
                    ...
                    <div className="bg-gray-50 dark:bg-gray-800 rounded-lg p-4 my-4">
                        ...
                        <ul className="space-y-2 text-sm">
                            <li>
                                <strong>Java:</strong> JDK 17 or higher
                            </li>
                            <li>
                                <strong>Gradle:</strong> 7.0 or higher
                            </li>
                            <li>
                            ...
                            <li>
                                <strong>Memory:</strong> Minimum 1GB RAM (2GB+
...
./gradlew --version`}</code>
                ...
                <section id="installation">
                    <h2>Installation</h2>
                    <p>
                        Add the SCAN plugin to your{" "}
                        <code>build.gradle.kts</code> or{" "}
    ...
    id 'io.github.theaniketraj.scan' version '2.2.0'
                    ...
                    <p>
                        If you&apos;re using an older Gradle version, you can
                        use the legacy plugin syntax:
                    </p>
                    <pre className="bg-gray-900 text-white p-4 rounded-lg overflow-x-auto">
                        <code>{`buildscript {
    repositories {
...
apply plugin: "io.github.theaniketraj.scan"`}</code>
                    ...
                    <div className="bg-blue-50 dark:bg-blue-900/30 border border-blue-200 dark:border-blue-700 rounded-lg p-4 my-6">
                        ...
                        <p className="text-blue-700 dark:text-blue-300 mb-0">
                            ...
                            patterns and performance improvements. Check the{" "}
                            <a
                                href="https://github.com/theaniketraj/SCAN/tags"
                                className="underline"
                                target="_blank"
                            >
                                releases page
                ...
                <section id="first-scan">
                    <h2>First Scan</h2>
                    <p>
                        Once the plugin is installed, you can run your first
                        security scan:
                    </p>

                    <pre className="bg-gray-900 text-white p-4 rounded-lg overflow-x-auto">
                        <code>{`# Run a basic scan
...
./gradlew scanForSecrets --debug`}</code>
                    </pre>
...
BUILD FAILED`}</code>
                ...
                <section id="configuration">
                    ...
                    <p>
                        Customize SCAN&apos;s behavior by adding a configuration
                        block to your build file:
                    </p>
    ...
    maxFileSize = 10
                    ...
                    <div className="bg-yellow-50 dark:bg-yellow-900/30 border border-yellow-200 dark:border-yellow-700 rounded-lg p-4 my-6">
                        ...
                        <p className="text-yellow-700 dark:text-yellow-300 mb-0">
                            Setting <code>failOnDetection = true</code> will
                            cause your build to fail when secrets are detected.
                            This is recommended for CI/CD pipelines to prevent
                            deployment of code with secrets.
                        </p>
                    </div>
                </section>
                ...
                <section id="understanding-results">
                    ...
                    <p>
                        SCAN provides detailed information about detected
                        secrets to help you understand and address security
                        issues.
                    </p>
                    ...
                    <div className="grid gap-4 md:grid-cols-2 my-6">
                        <div className="bg-gray-50 dark:bg-gray-800 rounded-lg p-4">
                            ...
                            <p className="text-sm text-gray-600 dark:text-gray-400">
                                Exact location of the file containing the
                                potential secret
                            </p>
                        </div>
                        <div className="bg-gray-50 dark:bg-gray-800 rounded-lg p-4">
                        ...
                        <div className="bg-gray-50 dark:bg-gray-800 rounded-lg p-4">
                            ...
                            <p className="text-sm text-gray-600 dark:text-gray-400">
                                Classification of the detected secret (API Key,
                                Password, etc.)
                            </p>
                        </div>
                        <div className="bg-gray-50 dark:bg-gray-800 rounded-lg p-4">
                            ...
                            <p className="text-sm text-gray-600 dark:text-gray-400">
                                Partial match showing the detected pattern
                    ...
                    <ul>
                        <li>
                            <strong>Console:</strong> Human-readable output for
                            development
                        </li>
                        <li>
                            <strong>JSON:</strong> Machine-readable for CI/CD
                            integration
                        </li>
                        <li>
                            <strong>HTML:</strong> Detailed web-based report
                            with navigation
                        </li>
                    </ul>
                </section>
                ...
                <section id="next-steps">
                    <h2>Next Steps</h2>
                    <p>
                        Now that you have SCAN running, explore these topics to
                    ...
                    <div className="grid gap-4 md:grid-cols-2 my-8">
                        <div className="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg p-6">
                            ...
                            <p className="text-gray-600 dark:text-gray-300 mb-4 text-sm">
                                Learn advanced features, best practices, and
                        ...
                        <div className="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg p-6">
                            ...
                            <p className="text-gray-600 dark:text-gray-300 mb-4 text-sm">
                                Customize patterns, exclusions, and output
                        ...
                        <div className="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg p-6">
                            ...
                            <p className="text-gray-600 dark:text-gray-300 mb-4 text-sm">
                                Understand built-in patterns and create custom
                                detection rules.
                            </p>
                            <Link
                                href="/docs/patterns"
                        ...
                        <div className="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg p-6">
                            ...
                            <p className="text-gray-600 dark:text-gray-300 mb-4 text-sm">
                                Integrate SCAN into your automated build and
                    ...
                    <div className="bg-blue-50 dark:bg-blue-900/30 border border-blue-200 dark:border-blue-700 rounded-lg p-6 my-8">
                        ...
                        <div className="space-y-2 text-blue-700 dark:text-blue-300">
                            ...
                            <label className="flex items-center">
                                <input type="checkbox" className="mr-2" /> First
                                scan completed successfully
                            </label>
                            <label className="flex items-center">
                                <input type="checkbox" className="mr-2" /> Build
                                failure configured for CI/CD
                            </label>
                            <label className="flex items-center">
                                <input type="checkbox" className="mr-2" />{" "}
                                Exclusions configured for test files
                            </label>
                            <label className="flex items-center">
                                <input type="checkbox" className="mr-2" /> Team
                                notified of new security checks
                            </label>
                        </div>
                    </div>
                </section>
