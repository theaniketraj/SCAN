...
export default function PatternsPage() {
        ...
        <DocsLayout sections={sections} title="Pattern Reference">
            <div className="prose prose-lg dark:prose-invert max-w-none">
                ...
                <p className="text-xl text-gray-600 dark:text-gray-300">
                    This document provides a comprehensive reference for all
                    built-in patterns used by the SCAN plugin and guidance on
                ...
                <p>
                    SCAN uses regular expressions (regex) to identify potential
                    secrets in your codebase. The plugin includes over 50
                    built-in patterns covering common secret types, and you can
                ...
                <ol>
                    <li>
                        <strong>Pattern Matching</strong>: SCAN scans each file
                        line by line, applying regex patterns
                    </li>
                    <li>
                        <strong>Context Analysis</strong>: The surrounding code
                        context is analyzed to reduce false positives
                    </li>
                    <li>
                        <strong>Entropy Analysis</strong>: High-entropy strings
                        are flagged even if they don&apos;t match specific
                        patterns
                    </li>
                    <li>
                        <strong>Confidence Scoring</strong>: Each finding is
                        assigned a confidence level based on multiple factors
                    </li>
                </ol>
                ...
                <div className="space-y-4">
                    <div className="bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-800 rounded-lg p-4">
                        ...
                        <p className="text-red-700 dark:text-red-300">
                            <strong>Pattern:</strong>{" "}
                            <code>AIza[0-9A-Za-z-_]{`{35}`}</code>
                        </p>
                        <p className="text-red-700 dark:text-red-300">
                            <strong>Example:</strong>{" "}
                            <code>AIzaSyDaGmWKa4JsXZ-HjGw7ISLn_3namBGewQe</code>
                        </p>
                        <p className="text-red-700 dark:text-red-300">
                            <strong>Confidence:</strong> High
                        </p>
                ...
                <div className="space-y-4">
                    <div className="bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-800 rounded-lg p-4">
                        ...
                        <p className="text-red-700 dark:text-red-300">
                            <strong>Description:</strong> Azure storage
                            connection strings
                        </p>
                        <p className="text-red-700 dark:text-red-300">
                            <strong>Confidence:</strong> High
                ...
                <div className="space-y-4">
                    <div className="bg-orange-50 dark:bg-orange-900/20 border border-orange-200 dark:border-orange-800 rounded-lg p-4">
                        <h4 className="text-orange-800 dark:text-orange-200 mt-0">
                            GitHub Personal Access Token
                        </h4>
                        <p className="text-orange-700 dark:text-orange-300">
                            <strong>Pattern:</strong>{" "}
                            <code>ghp_[A-Za-z0-9]{`{36}`}</code>
                        </p>
                        <p className="text-orange-700 dark:text-orange-300">
                            <strong>Example:</strong>{" "}
                            <code>
                    ...
                    <div className="bg-orange-50 dark:bg-orange-900/20 border border-orange-200 dark:border-orange-800 rounded-lg p-4">
                        ...
                        <p className="text-orange-700 dark:text-orange-300">
                            <strong>Pattern:</strong>{" "}
                            <code>gho_[A-Za-z0-9]{`{36}`}</code>
                        </p>
                        <p className="text-orange-700 dark:text-orange-300">
                            <strong>Description:</strong> GitHub OAuth access
                            tokens
                        </p>
                        <p className="text-orange-700 dark:text-orange-300">
                            <strong>Confidence:</strong> High
                ...
                <div className="space-y-4">
                    <div className="bg-orange-50 dark:bg-orange-900/20 border border-orange-200 dark:border-orange-800 rounded-lg p-4">
                        ...
                        <p className="text-orange-700 dark:text-orange-300">
                            <strong>Pattern:</strong>{" "}
                            <code>glpat-[A-Za-z0-9-_]{`{20}`}</code>
                        </p>
                        <p className="text-orange-700 dark:text-orange-300">
                            <strong>Description:</strong> GitLab personal access
                            tokens
                        </p>
                        <p className="text-orange-700 dark:text-orange-300">
                            <strong>Confidence:</strong> High
                ...
                <div className="space-y-4">
                    <div className="bg-purple-50 dark:bg-purple-900/20 border border-purple-200 dark:border-purple-800 rounded-lg p-4">
                        <h4 className="text-purple-800 dark:text-purple-200 mt-0">
                            Slack Token
                        </h4>
                        <p className="text-purple-700 dark:text-purple-300">
                            <strong>Pattern:</strong>{" "}
                            <code>xox[baprs]-[A-Za-z0-9]{`{10,48}`}</code>
                        </p>
                        <p className="text-purple-700 dark:text-purple-300">
                            <strong>Example:</strong>{" "}
                            <code>
                    ...
                    <div className="bg-purple-50 dark:bg-purple-900/20 border border-purple-200 dark:border-purple-800 rounded-lg p-4">
                        ...
                        <p className="text-purple-700 dark:text-purple-300">
                            <strong>Pattern:</strong>{" "}
                            <code>sk_live_[A-Za-z0-9]{`{24}`}</code>
                        </p>
                        <p className="text-purple-700 dark:text-purple-300">
                            <strong>Description:</strong> Stripe live API keys
                        </p>
                        <p className="text-purple-700 dark:text-purple-300">
                            <strong>Confidence:</strong> High
                        </p>
                ...
                <div className="space-y-4">
                    <div className="bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-800 rounded-lg p-4">
                        ...
                        <p className="text-red-700 dark:text-red-300">
                            <strong>Pattern:</strong>{" "}
                            <code>-----BEGIN [A-Z]+ PRIVATE KEY-----</code>
                        </p>
                        <p className="text-red-700 dark:text-red-300">
                            <strong>Description:</strong> PEM-formatted private
                            keys
                        </p>
                        <p className="text-red-700 dark:text-red-300">
                            <strong>Confidence:</strong> High
    ...
    customPatterns = listOf(
        ...
        "ACME_[A-Z]{2}_[0-9]{8}_[A-Za-z0-9]{16}"
                ...
                <p>
                    You can organize custom patterns in separate YAML files for
  ...
  - name: "Internal Secret"
    ...
    confidence: "medium"
    description: "Internal application secrets"`}</code>
                </pre>
    ...
    customPatternsFile = "patterns/custom-patterns.yml"
                ...
                <ol>
                    <li>
                        <strong>Be Specific</strong>: Avoid overly broad
                        patterns that cause false positives
                    </li>
                    <li>
                        <strong>Use Anchors</strong>: Use <code>^</code> and{" "}
                        <code>$</code> when matching entire lines
                    </li>
                    <li>
                        <strong>Consider Context</strong>: Think about where the
                        pattern might appear
                    </li>
                    <li>
                        <strong>Test Thoroughly</strong>: Validate against real
                        codebases
                    </li>
                </ol>
                ...
                <div className="bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-800 rounded-lg p-6 my-6">
                    ...
                    <pre className="bg-gray-900 text-white p-3 rounded mt-3 text-sm">
                        <code>{`// Too broad - will match everything
".*password.*"
...
"password\\\\s*=\\\\s*[\\\"'][^\\\"']{8,}[\\\"']"`}</code>
                ...
                <div className="bg-green-50 dark:bg-green-900/20 border border-green-200 dark:border-green-800 rounded-lg p-6 my-6">
                    ...
                    <pre className="bg-gray-900 text-white p-3 rounded mt-3 text-sm">
                        <code>{`// Case sensitive - might miss variations
"Password"
...
"(?i)password"`}</code>
                ...
                <div className="bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-lg p-6 my-8">
                    <h3 className="text-blue-800 dark:text-blue-200 mt-0">
