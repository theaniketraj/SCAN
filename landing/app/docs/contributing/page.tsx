        ...
        <DocsLayout sections={sections} title="Contributing">
            <div className="prose prose-lg dark:prose-invert max-w-none">
                ...
                <p className="text-xl text-gray-600 dark:text-gray-300">
                    Thank you for your interest in contributing to SCAN! This
                    guide will help you get started with contributing to the
                    project, from setting up your development environment to
                    submitting your first pull request.
                </p>

                <div className="bg-green-50 dark:bg-green-900/30 border border-green-200 dark:border-green-700 rounded-lg p-6 my-8">
                    <h3 className="text-green-800 dark:text-green-200 text-lg font-semibold mb-3">
                ...
                <section id="overview">
                    ...
                    <p>
                        SCAN (Sensitive Code Analyzer for Nerds) is an
                        open-source Gradle plugin that helps developers detect
                        secrets and sensitive information in their codebase. We
                        welcome contributions from the community to make this
                        tool even better.
                    </p>
                    ...
                    <p>
                        ...
                        <a
                            href="https://github.com/theaniketraj/SCAN/blob/main/CODE_OF_CONDUCT.md"
                            target="_blank"
                ...
                <section id="getting-started">
                    ...
                    <div className="bg-gray-50 dark:bg-gray-800 rounded-lg p-4 my-4">
                        <ul className="space-y-2 text-sm mb-0">
                            <li>
                                <strong>Java 21</strong> or higher
                            </li>
                            <li>
                                <strong>Gradle 8.14+</strong> (wrapper included)
                            </li>
                            <li>
                                <strong>Git</strong> for version control
                            </li>
                            <li>
                                <strong>IDE</strong> (IntelliJ IDEA recommended)
                            </li>
                        </ul>
                    </div>
                    ...
                    <pre className="bg-gray-900 text-white p-4 rounded-lg overflow-x-auto">
                        <code>{`git clone https://github.com/theaniketraj/SCAN.git
cd SCAN`}</code>
                    </pre>

                    <p>3. Add the upstream remote:</p>
                    <pre className="bg-gray-900 text-white p-4 rounded-lg overflow-x-auto">
                        <code>{`git remote add upstream https://github.com/theaniketraj/SCAN.git`}</code>
                    </pre>
                </section>
...
└── examples/               # Usage examples`}</code>
                    ...
                    <div className="grid gap-4 md:grid-cols-2 my-6">
                        <div className="bg-gray-50 dark:bg-gray-800 rounded-lg p-4">
                            ...
                            <div className="space-y-1 text-sm text-gray-600 dark:text-gray-400">
                                <p>
                                    <code>./gradlew build</code> - Build project
                                </p>
                                <p>
                                    <code>./gradlew test</code> - Run tests
                                </p>
                                <p>
                                    <code>./gradlew functionalTest</code> -
                                    Integration tests
                                </p>
                            </div>
                        </div>
                        <div className="bg-gray-50 dark:bg-gray-800 rounded-lg p-4">
                            ...
                            <div className="space-y-1 text-sm text-gray-600 dark:text-gray-400">
                                <p>
                                    <code>./gradlew spotlessCheck</code> - Check
                                    code style
                                </p>
                                <p>
                                    <code>./gradlew spotlessApply</code> - Fix
                                    code style
                                </p>
                                <p>
                                    <code>./gradlew detekt</code> - Static
                                    analysis
                                </p>
                            </div>
                        </div>
                ...
                <section id="contribution-types">
                    ...
                    <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3 my-6">
                        ...
                        <div className="bg-purple-50 dark:bg-purple-900/30 border border-purple-200 dark:border-purple-700 rounded-lg p-4">
                            <h4 className="text-purple-800 dark:text-purple-200 font-semibold mb-2">
                                🔍 Patterns
                            </h4>
                        ...
                        <div className="bg-indigo-50 dark:bg-indigo-900/30 border border-indigo-200 dark:border-indigo-700 rounded-lg p-4">
                            <h4 className="text-indigo-800 dark:text-indigo-200 font-semibold mb-2">
                                🧪 Testing
                            </h4>
                    ...
                    <ol>
                        <li>
                            Check existing issues to see if your contribution is
                            already being worked on
                        </li>
                        <li>
                            Create an issue to discuss major changes before
                            implementing
                        </li>
                ...
                <section id="code-standards">
                    ...
                    <p>
                        We follow the{" "}
                        <a
                            href="https://kotlinlang.org/docs/coding-conventions.html"
                            className="text-primary-600 dark:text-primary-400 hover:underline"
                        >
                    ...
                    <div className="bg-gray-50 dark:bg-gray-800 rounded-lg p-4 my-4">
                        ...
                        <ul className="space-y-1 text-sm">
                            <li>
                                <strong>Line length:</strong> 120 characters
                                maximum
                            </li>
                            <li>
                                <strong>Indentation:</strong> 4 spaces (no tabs)
                            </li>
                            <li>
                                <strong>Import order:</strong> Standard Kotlin
                                import ordering
                            </li>
                            <li>
                                <strong>Trailing commas:</strong> Enabled for
...
const val DEFAULT_ENTROPY_THRESHOLD = 4.5`}</code>
                    </pre>
...
fun detectSecrets(
    ...
    patterns: List<Pattern>
                ...
                <section id="testing">
                    ...
                    <p>
                        We maintain high test coverage with different types of
                        tests:
                    </p>

                    <h4>Unit Tests</h4>
                    <pre className="bg-gray-900 text-white p-4 rounded-lg overflow-x-auto">
                        <code>{`class SecretDetectorTest {
        ...
        .isEqualTo(TaskOutcome.FAILED)
                    ...
                    <div className="bg-yellow-50 dark:bg-yellow-900/30 border border-yellow-200 dark:border-yellow-700 rounded-lg p-4 my-6">
                        ...
                        <ul className="text-yellow-700 dark:text-yellow-300 space-y-1 text-sm">
                            <li>
                                <strong>Target:</strong> 80% line coverage
                                minimum
                            </li>
                            <li>
                            ...
                            <li>
                                <strong>Edge cases:</strong> Test boundary
                ...
                <section id="documentation">
                    ...
                    <ul>
                        <li>
                            <strong>Clear examples:</strong> Provide working
                            code examples
                        </li>
                        <li>
                            <strong>Step-by-step guides:</strong> Break down
                            complex procedures
                        </li>
                        <li>
                            <strong>Common use cases:</strong> Cover typical
                            scenarios
                        </li>
                        <li>
                            <strong>Troubleshooting:</strong> Address common
                            issues
                        </li>
                    </ul>
                </section>
...
docs(user-guide): Add CI/CD integration examples`}</code>
                    </pre>
                ...
                <section id="issue-reporting">
                    ...
                    <div className="bg-red-50 dark:bg-red-900/30 border border-red-200 dark:border-red-700 rounded-lg p-4 my-4">
                        <ul className="text-red-700 dark:text-red-300 space-y-1 text-sm">
                            ...
                            <li>
                                • Environment details (OS, Java version, Gradle
                                version)
                            </li>
                ...
                <section id="community">
                    ...
                    <ul>
                        <li>
                            <strong>Release notes:</strong> Major contributions
                            acknowledged
                        </li>
                        <li>
                            <strong>Contributors file:</strong> All contributors
                            listed
                        </li>
                        <li>
                            <strong>Special thanks:</strong> Outstanding
                    ...
                    <div className="bg-green-50 dark:bg-green-900/30 border border-green-200 dark:border-green-700 rounded-lg p-6 my-8">
                        ...
                        <div className="text-green-700 dark:text-green-300 space-y-2">
                            ...
                            <p>
                                Join our community and help make codebases more
                                secure for everyone! 🔒✨
                            </p>
                        </div>
                    </div>
